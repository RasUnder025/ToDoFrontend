...
function App() {
  ...
  const fetchTasks = async (token) => {
    const response = await fetch(
      "https://todobackend-a0ch.onrender.com/tasks",
      {
  ...
  const deleteTask = async (id) => {
    await fetch(`https://todobackend-a0ch.onrender.com/tasks/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${token}` },
    });
  ...
  const updateTaskStatus = async (id, currentStatus) => {
    ...
    const response = await fetch(
      `https://todobackend-a0ch.onrender.com/tasks/${id}/status`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
  ...
  const updateTaskPriority = async (id, newPriority) => {
    const response = await fetch(
      `https://todobackend-a0ch.onrender.com/tasks/${id}/priority`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
